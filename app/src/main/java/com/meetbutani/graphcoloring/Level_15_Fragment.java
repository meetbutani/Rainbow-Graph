...
public class Level_15_Fragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_level_15, container, false);
        context = getContext();
        ...
        check.setOnClickListener(v -> {
            ...
            if (isNonEmpty(vertices) && minColor(4, vertices) && checkHarmoniousColor(v1, v2, v4) && checkHarmoniousColor(v2, v3, v1) && checkHarmoniousColor(v3, v2, v7, v8) && checkHarmoniousColor(v4, v1, v7) && checkHarmoniousColor(v5, v6, v8) && checkHarmoniousColor(v6, v2, v5, v8)  && checkHarmoniousColor(v7, v3, v4)  && checkHarmoniousColor(v8, v3, v5, v6)) {
                //                status.setImageResource(R.drawable.ic_correct);

                levelComplete(15, new Level_16_Fragment(), "Level 16");

            } else {
//                status.setImageResource(R.drawable.ic_wrong);

                levelFailed(15, new Level_15_Fragment(), "Level 15");
            }
