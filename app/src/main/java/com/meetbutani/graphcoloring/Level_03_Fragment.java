...
public class Level_03_Fragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_level_03, container, false);
        context = getContext();
        ...
        check.setOnClickListener(v -> {
            ...
            if (isNonEmpty(vertices) && minColor(4, vertices) && checkHarmoniousColor(v1, v2, v4) && checkHarmoniousColor(v2, v3, v1) && checkHarmoniousColor(v3, v2, v4) && checkHarmoniousColor(v4, v1, v3)) {
                //                status.setImageResource(R.drawable.ic_correct);

                levelComplete(3, new Level_03_Fragment(), "Level 3");

            } else {
//                status.setImageResource(R.drawable.ic_wrong);

                levelFailed(3, new Level_03_Fragment(), "Level 3");
            }
