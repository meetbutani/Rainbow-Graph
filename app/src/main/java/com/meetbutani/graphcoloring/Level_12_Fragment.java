...
public class Level_12_Fragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_level_12, container, false);
        context = getContext();
        ...
        check.setOnClickListener(v -> {
            ...
            if (isNonEmpty(vertices) && minColor(4, vertices) && checkHarmoniousColor(v1, v2, v4) && checkHarmoniousColor(v2, v3, v1) && checkHarmoniousColor(v3, v2, v5, v7) && checkHarmoniousColor(v4, v1, v7) && checkHarmoniousColor(v5, v3, v6) && checkHarmoniousColor(v6, v5) && checkHarmoniousColor(v7, v3, v4)) {
                //                status.setImageResource(R.drawable.ic_correct);

                levelComplete(12, new Level_13_Fragment(), "Level 13");

            } else {
//                status.setImageResource(R.drawable.ic_wrong);

                levelFailed(12, new Level_12_Fragment(), "Level 12");
            }
