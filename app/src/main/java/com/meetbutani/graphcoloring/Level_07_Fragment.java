...
public class Level_07_Fragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_level_07, container, false);
        context = getContext();
        ...
        check.setOnClickListener(v -> {
            ...
            if (isNonEmpty(vertices) && minColor(4, vertices) && checkHarmoniousColor(v1, v2) && checkHarmoniousColor(v2, v5, v1) && checkHarmoniousColor(v3, v5, v4) && checkHarmoniousColor(v4, v5, v3) && checkHarmoniousColor(v5, v2, v3, v4)) {
                //                status.setImageResource(R.drawable.ic_correct);

                levelComplete(7, new Level_08_Fragment(), "Level 8");

            } else {
//                status.setImageResource(R.drawable.ic_wrong);

                levelFailed(7, new Level_07_Fragment(), "Level 7");
            }
