package com.meetbutani.graphcoloring.CustomView;
...
public class CustomTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            @SuppressLint({"CustomViewStyleable", "Recycle"}) TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.MagicTextView);
            ...
            if (a.hasValue(R.styleable.MagicTextView_android_background)) {
                Drawable background = a.getDrawable(R.styleable.MagicTextView_android_background);
                if (background != null) {
                    this.setBackgroundDrawable(background);
                } else {
                    this.setBackgroundColor(a.getColor(R.styleable.MagicTextView_android_background, 0xff000000));
                }
            }
    ...
    private void generateTempCanvas() {
        @SuppressLint("DefaultLocale") String key = String.format("%dx%d", getWidth(), getHeight());
