...
public class Level_11_Fragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_level_11, container, false);
        context = getContext();
        ...
        v4.setOnClickListener(v -> {
            if (selectedCol != 0) {
                ...
                edge46.setBackgroundDrawable(setHorEdgeColor(v4, v6));
                edge14.setBackgroundDrawable(setHorEdgeColor(v1, v4));
                edge34.setBackgroundDrawable(setEdgeColor(v3, v4));
            }
        });
        ...
        check.setOnClickListener(v -> {
            ...
            if (isNonEmpty(vertices) && minColor(4, vertices) && checkHarmoniousColor(v1, v2, v4, v6) && checkHarmoniousColor(v2, v3, v1, v5) && checkHarmoniousColor(v3, v2, v4, v5) && checkHarmoniousColor(v4, v1, v3, v6) && checkHarmoniousColor(v5, v2, v3, v6) && checkHarmoniousColor(v4, v1, v4, v5)) {
                //                status.setImageResource(R.drawable.ic_correct);

                levelComplete(11, new Level_12_Fragment(), "Level 12");

            } else {
//                status.setImageResource(R.drawable.ic_wrong);

                levelFailed(11, new Level_11_Fragment(), "Level 11");
            }
